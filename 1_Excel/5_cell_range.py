...
n_row_range = ws[2:ws.max_row]    # 2번째 줄부터 마지막 줄까지
for rows in n_row_range:
    for cell in rows:
        # print(cell.value, end=" ")
        # print(cell.coordinate, end=" ")    # cell의 좌표정보를 가지고 오기
...
# min_row, max_row, min_col, max_col 값 미설정시 자동으로 최소 최대 설정
